...
import imutils
from solver import *
def imageprocess(uimage):
    classes = np.arange(0, 10)

    model = load_model('flask-server\model-OCR.h5')
    # print(model.summary())
    input_size = 48
    ...
    try:
        ...
        while cv2.waitKey(1)==-1 and cv2.getWindowProperty('Final result',cv2.WND_PROP_VISIBLE)!=0:
            pass
    except:
...
imageprocess('uploaded_image.jpg')